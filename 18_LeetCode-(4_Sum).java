...
// 1). Time Complexity: O(N log N + N³ logN)
...
// 2). Space Complexity: O(1), (Generally the space complexity that is used to return the answer is ignored)
...
class _4Sum_Prob_2 {
    ...
    public static void main (String[] args) {
        int arr[] = {1,0,-1,0,-2,2};
        int target = 0;
        _4Sum_Prob_2 sol = new _4Sum_Prob_2();
